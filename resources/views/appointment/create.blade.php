         ...
         <div class="card-body">
            <div class="row">
               <div class="col-md-4 col-sm-12">
                  ...
                  <div class="form-group">
                    <label for="patient_name">{{ __('Doctor') }} @can('add doctor') - <a href="{{ route('doctor.create') }}" class="text-muted">{{ __('sentence.New Doctor') }}</a> @endcan</label>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
               ...
               <p><b>{{ __('Doctor') }} :</b> <span id="rdv_doctor"></span></p>
