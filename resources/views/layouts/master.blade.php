...
<head>
    ...
    <title>Health Care ERP - @yield('title') </title>
                        ...
                        <div id="collapseAppointment" class="collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                @can('view appointment')
                                    <a class="collapse-item"
                                          href="{{ route('allappointments') }}">My Appointments</a>
                ...
                @if (Auth::user()->can('manage settings'))
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseSettings" class="collapse" aria-labelledby="headingPages"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <a class="collapse-item" href="{{ route('doctor_settings.edit') }}">Settings</a>
                            </div>
                        </div>
                    </li>
                @endif
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <div class="dropdown shortcut-menu mr-4">
                            ...
                            <div class="dropdown-menu shadow">
                                ...
                                @if (Auth::user()->can('create diagnostic test'))
                                    <a class="dropdown-item"
                                        href="{{ route('test.create') }}">{{ __('sentence.Diagnosis Test') }}</a>
                                @endif
                            </div>
                        </div>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    @if (Auth::user()->can('manage settings'))
                                        ...
                                        <a class="dropdown-item" href="{{ route('doctor_settings.edit') }}">
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright my-auto">
                            <span>SE-18 | {{ date('Y') }} | Health Care ERP</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
