...
class SettingController extends Controller
{
    ...
    public function doctor_settings(Request $request){
    	...
    	return view('settings.doctor_settings', ['settings' => $settings, 'language' => $language]);
    }

    public function doctor_settings_store(Request $request){
    	...
    	return Redirect::route('doctor_settings.edit')->with('success', __("sentence.Settings edited Successfully") );
    }
