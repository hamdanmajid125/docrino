      ...
      <div class="col-md-8">
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               ...
               <span class="float-right">Total: <b id="total_income">0 </b> <?php echo e(App\Setting::get_option('currency')); ?></span>
            </div>
         </div>
      </div>
   </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\doctor\resources\views/billing/create.blade.php ENDPATH**/ ?>