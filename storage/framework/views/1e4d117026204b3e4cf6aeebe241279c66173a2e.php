...
<html lang="en">
   <head>
      ...
      <title>Health Care ERP - <?php echo $__env->yieldContent('title'); ?> </title>
         ...
         <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('home')); ?>">
                  ...
                  <div class="sidebar-brand-text mx-3">Health Care ERP</div>
               </a>
               <!-- Divider -->
               ...
               <?php if(Auth::user()->can('create prescription') || Auth::user()->can('view all prescriptions') || Auth::user()->can('view prescription')): ?>
               ...
               <li class="nav-item">
                  ...
                  <div id="collapseSettings" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('doctor_settings.edit')); ?>">Settings</a>
                     </div>
                  </div>
               </li>
               ...
               <div id="content">
                  ...
                  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                     ...
                     <div class="dropdown shortcut-menu mr-4">
                       <button type="button" class="btn btn-doctor brd-20 dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                     ...
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                           ...
                           <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                              ...
                              <a class="dropdown-item" href="<?php echo e(route('doctor_settings.edit')); ?>">
               ...
               <footer class="sticky-footer bg-white">
                  <div class="container my-auto">
                     <div class="copyright my-auto">
                        <span>SE-18 | <?php echo e(date('Y')); ?> | Health Care ERP</span>
                     </div>
                  </div>
               </footer>
               <!-- End of Footer -->
...
<?php /**PATH C:\Users\123\Desktop\practice\FYP - Copy\resources\views/layouts/master.blade.php ENDPATH**/ ?>