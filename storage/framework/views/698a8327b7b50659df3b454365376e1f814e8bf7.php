         ...
         <div class="card-body">
            <div class="row">
               <div class="col-md-4 col-sm-12">
                  ...
                  <div class="form-group">
                    <label for="patient_name"><?php echo e(__('Doctor')); ?> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add doctor')): ?> - <a href="<?php echo e(route('doctor.create')); ?>" class="text-muted"><?php echo e(__('sentence.New Doctor')); ?></a> <?php endif; ?></label>
                    <select class="form-control patient_name multiselect-doctorino"  id="doctor">
                       <option value="0"><?php echo e(__('Select Doctor')); ?></option>
                       <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <option value="<?php echo e($doctor->id); ?>"><?php echo e($doctor->name); ?> (ID : <?php echo e($doctor->id); ?>)</option>
                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                 </div>
                  <div class="form-group">
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
               ...
               <p><b><?php echo e(__('Doctor')); ?> :</b> <span id="rdv_doctor"></span></p>
         ...
         <div class="modal-footer">
            ...
            <form id="rdv-form" action="<?php echo e(route('appointment.store')); ?>" method="POST" class="d-none">
               ...
               <input type="hidden" name="doctor" id="doctor_input">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HAMDAN\Desktop\custom-backend\FYP - Copy\FYP - Copy\resources\views/appointment/create.blade.php ENDPATH**/ ?>