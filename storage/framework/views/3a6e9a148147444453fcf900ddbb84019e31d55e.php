            ...
            <div class="col-md-4">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <a class="btn btn-success w-100" href="<?php echo e(route('generatebill',$prescription->id)); ?>">Generate Bill</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HAMDAN\Documents\GitHub\docrino\resources\views/prescription/edit.blade.php ENDPATH**/ ?>