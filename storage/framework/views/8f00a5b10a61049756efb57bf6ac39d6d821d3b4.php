...
<div class="row justify-content-center">
   <div class="col-md-8">
      <div class="card shadow mb-4">
         ...
         <div class="card-body">
            <form method="post" action="<?php echo e(route('doctor_settings.store')); ?>" enctype="multipart/form-data">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                     ...
                     <input type="hidden" class="form-control" id="Currency" name="currency" value="Rs." required>
                  
                     <input type="hidden" class="form-control" id="Currency" name="vat" value="0" required>
                  
                     <input type="hidden" class="form-control" name="language" value="en" id="Language">
               <hr>
               <div class="form-group row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\123\Documents\GitHub\docrino\resources\views/settings/doctor_settings.blade.php ENDPATH**/ ?>