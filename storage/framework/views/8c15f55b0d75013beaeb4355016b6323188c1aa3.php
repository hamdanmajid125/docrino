...
<html lang="en">
   <head>
      ...
      <title>Doctor App - <?php echo $__env->yieldContent('title'); ?> </title>
         ...
         <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('home')); ?>">
                  ...
                  <div class="sidebar-brand-text mx-3">Doctor App</div>
               </a>
               <!-- Divider -->
               ...
               <footer class="sticky-footer bg-white">
                  <div class="container my-auto">
                     <div class="copyright my-auto">
                        <span>Copyright &copy; <?php echo e(date('Y')); ?>. All rights reserved.</span>
                     </div>
                  </div>
               </footer>
               <!-- End of Footer -->
...
</html><?php /**PATH E:\xampp\htdocs\doctor\resources\views/layouts/master.blade.php ENDPATH**/ ?>