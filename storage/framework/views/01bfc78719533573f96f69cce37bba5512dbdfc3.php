                    ...
                    <div class="col-md-4 col-sm-6">
                      ...
                      <?php endif; ?>
                       <h4 class="text-center mt-3"><b><?php echo e($patient->name); ?></b> <label class="badge badge-primary-soft"> <a href="<?php echo e(url('patient/edit/'.$patient->id)); ?>" ><i class="fa fa-pen"></i></a></label></h4>
                            ...
                            <p><b>Patient Card:</b> <a target="_blank" href="<?php echo e(route('generatecard',$patient->Patient->id)); ?>">View</a></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HAMDAN\Desktop\custom-backend\FYP - Copy\FYP - Copy\resources\views/patient/view.blade.php ENDPATH**/ ?>