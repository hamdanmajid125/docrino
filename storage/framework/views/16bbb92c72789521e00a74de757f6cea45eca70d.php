        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <?php if(Auth::user()->can('create appointment') ||
                        ...
                        Auth::user()->can('delete appointment') || Auth::user()->can('view appointment')): ?>
                    <!-- Divider -->
                    <hr class="sidebar-divider">
                    <!-- Heading -->
                    <div class="sidebar-heading">
                        ...
                        <div id="collapseAppointment" class="collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view appointment')): ?>
                                    <a class="collapse-item"
                                          href="<?php echo e(route('allappointments')); ?>">My Appointments</a>
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <div class="dropdown shortcut-menu mr-4">
                            <button type="button" class="btn btn-doctor brd-20 dropdown-toggle"
...
<?php /**PATH C:\Users\HAMDAN\Desktop\custom-backend\FYP - Copy\FYP - Copy\resources\views/layouts/master.blade.php ENDPATH**/ ?>